import { BACKEND_HOME_URL, MAIL_FROM_ADDRESS } from "../config/Config.js";
export function generateTestDriveEmail(user, testDriveInfo, staff) {
  return `
        ...
        <tr>
          <td style="padding: 20px; text-align: left;">
            ...
            <p style="font-size: 16px; color: #333333; font-weight: bold;">
              Your requested car: <span style="color: #ff6600;">${testDriveInfo.getCar()}</span>
            </p>
