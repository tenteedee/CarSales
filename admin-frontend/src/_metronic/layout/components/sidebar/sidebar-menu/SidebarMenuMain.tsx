  ...
  return (
    <>
      ...
      {(hasRole('Director') || hasRole('Sale')) && (
        <SidebarMenuItem to='/test-drive' icon='ghost' title='Test Drive' fontIcon='bi-layers' />
      )}
      {hasRole('Director') && (
        <SidebarMenuItem to='/showrooms' icon='map' title='Showrooms' fontIcon='bi-layers' />
      )}
      {hasRole('Director') && (
        <SidebarMenuItem to='/news' icon='menu' title='News' fontIcon='bi-layers' />
      )}
      {hasRole('Director') && (
        <SidebarMenuItem to='/categories' icon='menu' title='News Category' fontIcon='bi-layers' />
      )}
      {hasRole('Director') && (
