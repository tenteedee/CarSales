...
import {handleDelete} from "../../../Showroom";
...
const ShowroomActionsCell: FC<Props> = ({id, value, ...props}) => {
    useEffect(() => {
        ...
        <>
            ...
            >
                ...
                <div className='menu-item px-3'>
                    <Link className='menu-link px-3' to={`/showrooms/edit/${id}`}>
                        Edit
                    </Link>
                </div>
                {/* end::Menu item */}
