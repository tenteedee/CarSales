    ...
    return (
        <div>
                ...
                <div id="carousel" className="slide carousel carousel-fade">
                    <div className="carousel-inner">
                        <div className="item active">
                            <img
                                src="src\assets\media\main-slider\4.jpg"
                                alt="sliderImg"
                            />
                    ...
                    <div className="row">
                        <div className="col-sm-4 col-xs-12">
                            ...
                            >
                                ...
                                <p>
                                    Curabitur libero. Donec facilisis velit eu
                                    est. Phasellus cons quat. Aenean vitae quam.
                                    Vivamus et nunc. Nunc consequ sem velde
                                    metus imperdiet lacinia.
                                </p>
                            </div>
                        </div>
                        <div className="col-sm-4 col-xs-12">
            ...
            <section className="b-featured">
                <div className="container">
                    <h2 className="s-title wow zoomInUp" data-wow-delay="0.3s">
                        Featured Vehicles
                    </h2>
                    <div
                        id="carousel-small"
