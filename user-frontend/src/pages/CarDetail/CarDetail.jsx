				...
				>
					...
					<div className='modal-body'>
						...
						<div className='insurance-options'>
							<label htmlFor='insuranceSelect' className='form-label'>Chọn bảo hiểm thân vỏ:</label>
							<select
							  id='insuranceSelect'
							...
							>
								<option value=''>Không mua bảo hiểm thân vỏ</option>
								{insurances
								  .filter((insurance) => insurance.type === 2)
								  .map((insurance) => {
									  const calculatedPrice = (carInfo.price * insurance.price / 100).toFixed(0);
									  return (
										<option key={insurance.id} value={insurance.id}>
											{insurance.name} - {formatCurrency(calculatedPrice)}
										</option>
									  );
								  })}
							</select>
